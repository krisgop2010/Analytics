...
# Use case:
#   
#   A bank approved many low value loans without much scrutiny. 
#Many of those loans resulted in default. 
#Those loans were for cars, furniture, electronics, continuing education, etc. 
#The bank thinks that they should have put more of an emphasis on their applicant 
#screening process. Specifically, the bank thinks that defaults are likely related to 
#customers who overdraw their checking account and customers who use the loan for electronics. 
#If this is indeed true, they will not give loans to new applicants having these characteristics.
# 

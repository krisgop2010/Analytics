#Home Loan Analytics using Logistic regression in R
#load data into dataframe
Home_Loan <- read.csv("C:\\DataSets\\HomeLoan.csv", sep='|', header = TRUE, na.strings = c("", " ", NA) )
dim(Home_Loan)

#Find summary of all columns in the raw file
